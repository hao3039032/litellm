...
class OpenCodeChatConfig(OpenAILikeChatConfig):
    ...
    ) -> dict[str, object]:  # mutable-ok: HTTP handler mutates returned headers
...
class OpenCodeMessagesChatConfig(AnthropicConfig):
    ...
    def get_model_response_iterator(
        ...
        return ModelResponseIterator(streaming_response, sync_stream, json_mode)
    ...
    def validate_environment(
        ...
        api_key: str | None = None,
        api_base: str | None = None,
    ) -> dict[str, object]:  # mutable-ok: return type is fixed by BaseConfig.validate_environment
        base_headers: Final[Mapping[str, object]] = super().validate_environment(
...
class OpenCodeZenGeminiChatConfig(GoogleAIStudioGeminiConfig):
    ...
    def transform_request(
        ...
        litellm_params: Mapping[str, object],
        headers: Mapping[str, object],
    ) -> dict[str, object]:  # mutable-ok: return type is fixed by BaseConfig.transform_request
        """
        ...
        from litellm.llms.vertex_ai.gemini.transformation import (
            _transform_request_body,  # pyright: ignore[reportPrivateUsage]  # shared Gemini body builder has no public equivalent
        )

        cached_content: Final = optional_params.get("cached_content")
        return dict(  # mutable-ok: BaseConfig transform contract requires dict
    ...
    def validate_environment(
        ...
        optional_params: Mapping[str, object],
        litellm_params: Mapping[str, object],
        api_key: str | dict[str, object] | None = None,  # mutable-ok: signature is fixed by VertexGeminiConfig
        api_base: str | None = None,
    ) -> dict[str, object]:  # mutable-ok: return type is fixed by BaseConfig.validate_environment
        """
        ...
        base_headers: Final[Mapping[str, object]] = MappingProxyType(
            dict(
                chain(
